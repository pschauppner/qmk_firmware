...
[_BL] = LAYOUT( \
  DM_REC1,  KC_0,     KC_1,     KC_2,     KC_UNDS,  KC_QUOT,                                           TD(TD_LPRN), TD(TD_RPRN), KC_PLUS,  KC_MINS,  KC_EQL,  KC_BSPC, \
  KC_TAB,   KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,                                                    KC_J,     KC_L,     KC_U,     KC_Y,     KC_SCLN, KC_DEL,  \
  KC_LEAD,  KC_A,     KC_R,     KC_S,     KC_T,     KC_G,                                                    KC_M,     KC_N,     KC_E,     KC_I,     KC_O,    KC_ENT,  \
  KC_LGUI,  KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,                                                    KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH, _______, \
                      KC_LEFT,  KC_RIGHT, KC_LALT,  KC_LSFT,  KC_LCTL,  MO(_NL),         DM_PLY1,  KC_TAB,   KC_SPC,   XXXXXXX,  KC_UP,    KC_DOWN \
),
...
[_NL] = LAYOUT( \
  ...
  _______,  _______,  _______,  _______,  _______,  _______,                                                 _______,  KC_KP_1,  KC_KP_2,  KC_KP_3,  KC_PENT, _______,  \
                      _______,  _______,  _______,  _______,  _______,  _______,         _______,  _______,  _______,  KC_KP_0,  _______,  KC_KP_DOT \
),
